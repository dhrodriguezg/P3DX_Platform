...
class StreamThread(threading.Thread):
    ...
    def formURL(self):
        self.url = 'http://%s/%s' % (self.axis.hostname, self.axis.resource)
    ...
    def authenticate(self):
        ...
        if self.axis.password != '' or self.axis.username != '':
...
class Axis:
    def __init__(self, hostname, username, password, resource, width, height, frame_id, 
